...
$sql = "INSERT INTO department (Train_id,Train_name,Train_type,Source_stn,Destination_stn,Source_id)
VALUES ('$Train_id',''$Train_name', '$Train_type' , '$Source_stn','$Destination_stn','$Source_id')";
